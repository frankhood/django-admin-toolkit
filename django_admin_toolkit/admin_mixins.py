...
from django_admin_toolkit.widgets import VerboseForeignKeyRawIdWidget, VerboseManyToManyRawIdWidget
...
class BaseAdminMixin(object):
    ...
    def _display_related_object(self, fk_field):
        logger.warning("Deprecated! -> Use _display_fk_object instead")
        return self._display_fk_object(fk_field)
    ...
    def _display_m2m_object(self, obj, m2m_field_name, label="elements"):
        logger.warning("This method is deprecated! -> Use _display_m2m_objects instead")
        return self._display_m2m_objects(obj, m2m_field_name, label=label)
